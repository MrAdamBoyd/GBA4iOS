...
+ (NSData *)dataWithBase64EncodedString:(NSString *)string {
    ...
    NSMutableData *outputData = [NSMutableData dataWithLength:[NSNumber numberWithLongLong:maxOutputLength].unsignedIntegerValue];
    ...
    outputData.length = [NSNumber numberWithLongLong:outputLength].unsignedIntegerValue;
