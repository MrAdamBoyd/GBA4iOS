...
- (void)updateFilter
{
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone && [[UIScreen mainScreen] scale] < 3.0 && [self portraitMode] && self.rom.type == GBAROMTypeGBA && ![self isAirplaying])
    {
